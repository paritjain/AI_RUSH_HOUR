"""
Steps:
    1. Choose a puzzle difficulty (Easy / Medium / Hard)
    2. Choose an action:
       a. Run ALL algorithms and compare results side-by-side
       b. Run one algorithm and open the visual step-through
"""
...
# Comparison mode – run every algorithm and print a table
...
# Single algorithm mode – solve + visualize
